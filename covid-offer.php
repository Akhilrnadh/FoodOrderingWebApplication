...
?>
 ...
 <div class="jumbotron text-center">
   <h1>Special Offers in Covid Situations<i class="fas fa-utensils"></i></h1>
 </div>
 <!--jumbotron code-->
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <?php 
        $sql = "select * from foodlist where fname like '%covid%' or fdescription like '%covid%' order by fid desc;";
        $result = mysqli_query($con, $sql);
        $resultcheck = mysqli_num_rows($result);
