...
?>
 ...
 <div class="jumbotron text-center">
   <h1>Special Greetings for Us<i class="fas fa-utensils"></i></h1>
 </div>
 <!--jumbotron code-->
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <?php 
        $sql = "select * from foodlist where fname like '%greetings%' or fdescription like '%greetings%' order by fid desc;";
        $result = mysqli_query($con, $sql);
        $resultcheck = mysqli_num_rows($result);
