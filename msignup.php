...
<div class="jumbotron">
	<h1>Add Your Hotel Details,<br> Welcome to <span style="color:green;">Fresh Food Court'</span></h1>
   ...
   <div class="container">
      ...
      <?php
          if (isset($_GET['msignup'])) {
            ...
            if ($errorcheck == "user"){
              echo "<p class='text-center alert alert-danger'>Username Already Taken, Kindly Use a Diffrent One</p>";
            }
            if ($errorcheck == "email"){
              echo "<p class='text-center alert alert-danger'>Enter a Valid Email Address</p>";
            }
            if ($errorcheck == "contact"){
