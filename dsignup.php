   	...
   	<div class="login col-md-6">
   	  <form method="POST" action="inc/dsignup.inc.php" class="pb-5" enctype="multipart/form-data">
      	...
      	<div class="form-group">
      	 <label>Full Name</label>
      		<input type="text" name="fname" autocomplete="off" placeholder="Your Full Name" class="form-control" required>
      	</div>
      	<div class="form-group">
        ...
        <div class="form-group">
      	 <label>Driving License Number</label>
      		<input type="text" name="dlicense" autocomplete="off" placeholder="License Number" class="form-control" required>
      	</div>
  
      	<div class="form-group">
      	 <label>Contact No</label>
      		<input type="text" name="contact" autocomplete="off" placeholder="Contact Number" class="form-control" required>
      	</div>
      	<div class="form-group">
      	 <label>Address</label>
      		<textarea name="address" autocomplete="off" placeholder="Your Address" class="form-control" required></textarea>
      	</div>
