...
<head>
  ...
  <title>F.F.C. | FRESH FOOD COURT</title>
...
<body>
  ...
  <a class="navbar-brand" href="index.php">F.F.C.</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="foodlist.php">Home - All Food Items</a>
      </li>
            <li class="nav-item">
        <a class="nav-link " href="covid-offer.php">Covid Offer</a>
      </li>
            <li class="nav-item">
        <a class="nav-link " href="birthday-special.php">Birthday Special</a>
      </li>
            <li class="nav-item">
        <a class="nav-link " href="greetings.php">Greetings</a>
      </li> 
    </ul>
...
?>
 ...
 <div class="jumbotron text-center">
   <h1>Surprise your Friends/Families Birthday with our Special Birthday Offers<i class="fas fa-utensils"></i></h1>
 </div>
 <!--jumbotron code-->
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <?php 
        $sql = "select * from foodlist where fname like '%birthday%' or fdescription like '%birthday%' order by fid desc;";
        $result = mysqli_query($con, $sql);
        $resultcheck = mysqli_num_rows($result);
